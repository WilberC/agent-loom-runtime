...
- Queues ack/error events locally and retries them in order after network failures. A `409` for an already-seen event is treated as delivered, so reconnects do not stall.
